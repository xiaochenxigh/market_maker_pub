...
class Fcoin():
    ...
    def buy(self, symbol, price, amount):
        """buy someting"""
        res =  self.create_order(symbol=symbol, side='buy', type='limit', price=str(price), amount=amount, exchange='qaconsensus')
        print(symbol,'buy',price,amount,res)

    def sell(self, symbol, price, amount):
        """buy someting"""
        res =  self.create_order(symbol=symbol, side='sell', type='limit', price=str(price), amount=amount,exchange='qaconsensus')
        print(symbol,'sell',price,amount,res)
